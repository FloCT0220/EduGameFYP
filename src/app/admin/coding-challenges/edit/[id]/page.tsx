...
export default function EditCodingChallenge({ params }: { params: Promise<{ id: string }> }) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          supported_language: fullChallenge.supported_language || fullChallenge.supported_languages || 'python',
          is_active: fullChallenge.is_active
        });
        
        // Set challenge answers if available
        if (fullChallenge.challenge_answers) {
          setChallengeAnswers(fullChallenge.challenge_answers);
        }
      } else {
      ...
      alert('Error fetching challenge details');
      router.push('/admin/coding-challenges');
    } finally {
      setIsLoading(false);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(error.error || 'Error updating challenge');
      }
    } catch (error) {
      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Edit Coding Challenge</h1>
            <button
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end space-x-4 mt-8 pt-6 border-t">
                ...
                >
                  {isSaving ? 'Updating...' : 'Update Challenge'}
                </button>
              </div>
            </form>
          </div>
